...
public class SeedWheelHistory {
    ...
    public static void insertData() throws ParseException {
        ...
        if (count == 0) {
            ...
            // Insert WheelHistory
            WheelHistory wheelHistory01 = new WheelHistory(1L, "hoaipx", "Nhận được 1000 điểm",
                    format.parse("2021/08/04 09:37:12"));
            WheelHistory wheelHistory02 = new WheelHistory(2L, "vanbich", "Nhận được mã đổi điểm",
                    format.parse("2021/07/14 19:37:12"));
            WheelHistory wheelHistory03 = new WheelHistory(3L, "tulehoang", "Nhận được mã đổi điểm",
                    format.parse("2021/06/11 09:17:12"));
            WheelHistory wheelHistory04 = new WheelHistory(4L, "huypquang", "Nhận được 500 điểm",
                    format.parse("2021/3/02 09:37:10"));
            WheelHistory wheelHistory05 = new WheelHistory(5L, "luanluan", "Nhận được 1500 điểm",
                    format.parse("2021/04/04 08:11:12"));
            WheelHistory wheelHistory06 = new WheelHistory(6L, "hoaipx", "Nhận được mã đổi điểm",
                    format.parse("2021/07/05 01:17:12"));
            WheelHistory wheelHistory07 = new WheelHistory(7L, "tulehoang", "Nhận được 1000 điểm",
                    format.parse("2021/01/04 01:37:12"));
