...
const Content = () => {
  ...
  return (
    <Container className={classes.cardGrid} maxWidth="lg">
      ...
      <Typography variant="subtitle1" paragraph>
        <b>Vào những năm 80</b>, Drip&Chill khai trương ba cửa hàng đầu tiên tại
        Thành phố Hà Nội trên đường Lê Văn Sỹ, Trần Hưng Đạo và Mạc Thị
        Bưởi nhằm giới thiệu sản phẩm trà và cà phê thuần Việt đến với khách
        hàng trong nước cũng như quốc tế.
      </Typography>
      <Typography variant="subtitle1" paragraph>
        Đặc biệt, cửa hàng Drip&Chill Mạc Thị Bưởi toạ lạc tại trung tâm Quận 1
        là cửa hàng đầu tiên phục vụ các thức uống Trà pha chế đặc trưng của
        Drip&Chill và Cà-phê pha máy cao cấp thường chỉ được phục vụ tại các nhà
        hàng sang trọng vào giai đoạn đó.
      </Typography>
      <Typography variant="subtitle1" paragraph>
        <b>Năm 2000</b>, công ty TNHH Sản Xuất Thương Mại Drip&Chill chính thức
        được thành lập.
      </Typography>
      <Typography variant="subtitle1" paragraph>
        <b>Năm 2007</b>, Drip&Chill sở hữu đồi chè tại Thái Nguyên. Bởi chính bản
        ...
        Thái Nguyên. Drip&Chill mong muốn qua việc đặt nhà máy ngay tại vùng
        ...
        lượng tổng thể. Đồng thời trong năm 2007, Drip&Chill đầu tư nhà máy chế
        ...
        Cũng từ đây, Trà Drip&Chill đã đáp ứng đầy đủ tiêu chuẩn để có mặt tại
        các thị trường khó tính như: Mỹ, Nhật Bản, Indonesia, Philippines…
      </Typography>
      <Typography variant="subtitle1" paragraph>
        <b>Năm 2012</b>, cửa hàng Drip&Chill Coffee & Tea tại TTTM Crescent Mall
        Quận 7 ra mắt đánh dấu việc Drip&Chill chính thức mở rộng vào ngành đồ ăn
        & thức uống (Food & Beverage) với cửa hàng Drip&Chill hoạt động theo mô
        ...
        lịch sự phát triển của Drip&Chill.
      </Typography>
      <Typography variant="subtitle1" paragraph>
        <b>Năm 2015</b>, Drip&Chill xây dựng được 10 cửa hàng tại Thành Phố Hồ
      ...
      <Typography variant="subtitle1" paragraph>
        ...
        chè Thái Nguyên và Bảo Lộc. Đồng thời hơn 40 cửa hàng Drip&Chill được xây
        dựng tại: Thành phố Hà Nội, Bình Dương, Nha Trang, Đà Nẵng, Hà Nội.
      ...
      <Typography variant="subtitle1" paragraph>
        ...
        giá trị nhất khi thưởng thức, Drip&Chill liên tục là thương hiệu tiên
      ...
      <Typography variant="subtitle1" paragraph>
        ...
        Tiếp nối nỗ lực, từ một cửa hàng đầu tiên, đến nay, Drip&Chill xây dựng
      ...
      <Typography variant="subtitle1" paragraph>
        ...
        vững, Drip&Chill phấn đấu trở thành công ty chuyên sản xuất và xuất khẩu
        trà, cà phê có giá trị cao tại Việt Nam.
      </Typography>
      <Typography variant="subtitle1" paragraph>
        <b>2</b>. Drip&Chill mong muốn tạo nên một thương hiệu Việt với đẳng cấp
